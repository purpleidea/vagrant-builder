...
PACKAGES='sudo vim-nox git wget file man tree nmap tcpdump htop lsof telnet mlocate bind-utils iftop nc psmisc bash-completion moreutils'	# list of extra packages to include
