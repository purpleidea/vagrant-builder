...
PACKAGES='sudo make vim-nox git wget file man tree nmap tcpdump htop lsof telnet mlocate bind9-host iftop netcat psmisc bash-completion moreutils'	# list of extra packages to include
